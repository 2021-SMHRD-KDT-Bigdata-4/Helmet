<%@page import="kr.smhrd.model.ContactusVO"%>
...
<body>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<form id="ufrm" class="form-horizontal"
					...
					<div class="col-sm-offset-2 col-sm-10">
						<c:if test="${!empty sessionScope.userVO}">
							<button type="button" class="btn btn-default btn-primary btn-sm"
								onclick="updateFn()">수정</button>
						</c:if>
						<button type="button" class="btn btn-default btn-warning btn-sm"
							onclick="contentFn1()">취소</button>
						<button type="button" class="btn btn-default btn-success btn-sm"
							onclick="closeFn()">
