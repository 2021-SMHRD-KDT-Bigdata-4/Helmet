...
<script type="text/javascript">
	   ...
	   function mypointlistFn2(){
	         $.ajax({
	            url : "mypointlist2.go",
	            type : "get",
	            data : { "memberid" : memberid},
	            success : mypointlist2,
	            dataType : "json",
	            error : function() {
	   ...
	   function mypointlist2(data) {
	         ...
	         $.each(data,(index,obj) =>{
	             view += "<tr>";
	             view += "<td>" + obj.earndate2 + "</td>";
	             view += "<td>" + obj.earnpoint2 + "</td>";
	             view += "<td>" + obj.useddate2 + "</td>";
	             view += "<td>" + obj.usedpoint2 + "</td>";
	             view += "</tr>";
	         });
	          view+="</table>";
	          $("#mypage2").append(view); 
						...
						<form action="main.jsp" method="get"
							...
							<div>
										<div id="pntshow1">
											<table class="tbl">
												...
												<tbody>
													<tr>
														<td>잔여포인트</td>
														<td id="change"><input value ='32400'></td>
													</tr>
													<tr>
														<th>결제금액</th>
														<td></section>
										...
										<button type="button"
											...
											id="btnpoint2" onclick="usePoint2()">포인트 사용하기</button>
									</div>
